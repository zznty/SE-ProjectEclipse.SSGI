...
namespace ProjectEclipse.Backend.Reflection.Wrappers
{
    ...
    {
        public Texture2D Texture => (Texture2D)BorrowedTextureAccessor.GetResource(_borrowedUavTexture);
        ...
        public int MipLevels => BorrowedTextureAccessor.GetMipLevels(_borrowedUavTexture);
